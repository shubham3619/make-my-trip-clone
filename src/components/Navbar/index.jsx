...
const Navbar = () => {
  return (
    <div className="flex justify-between items-center py-4 px-4 md:px-8">
      {/* Logo */}
      <div>
        <img className="w-32 md:w-40" src={navLogo} alt="Make My Trip" />
      </div>
      ...
      <div className="hidden md:flex">
        <ul className="flex justify-center items-center gap-6 md:gap-8">
          ...
          <li>
            <Button className="text-[12px] w-[200px] bg-gradient-to-r from-blue-300 to-blue-700">
      ...
      <div className="md:hidden">
        <Button className="text-[12px] w-auto bg-gradient-to-r from-blue-300 to-blue-700">
          Login or Create Account
        </Button>
      </div>
    </div>
